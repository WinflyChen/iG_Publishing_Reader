  ...
  --       screenBlockGroup:insert(showContentPage)
    ...
    local function Check_metadata(event)
        ...
        if JSON_metadata ~= nil and JSON_metadata[1].bookcode ~= "" and JSON_metadata[1].pages ~= "" then
            ...
            --process.downlProcess.downloadBook("scene_download_number_h", JSON_metadata[1].bookcode, JSON_metadata[1].pages) --JSON_metadata[1].pages
        end
        ...
        if event.count >= 4 then
            ...
            print("SSSSSSSSSSSSSSSSSSSSSSSSSSSSS_hhhhhhhhh")
        end 
    end
    ...
    local function Check_convertstatusmobile(event)
        ...
        if event.count >= 4 then
            ...
            if messageGroup[2] ~= nil then
                messageGroup.text = JSON_convertstatus[1].message
    ...
    function Button_Yes(top_y)
        -- button event
                ...
                --timer.performWithDelay( 200, Check_convertstatusmobile,2)
    ...
    local function Button_No(top_y)
        ...
        print("aaaaaaaaaaaaaaaaaaaaaaaa")
            if event.phase == "ended" then
                ...
                composer.gotoScene("scene_bookshelf_h", changeSceneEffectSetting)
            end
        end
    ...
    function scene:Done(errpage) -- 下載完成後的檢查
        ...
        if JSON_metadata ~= nil and JSON_metadata[1].bookcode ~= "" and JSON_metadata[1].pages ~= "" then
            ...
            --system.pathForFile( idPath.."precent.txt", system.DocumentsDirectory )
    ...
    function scene:show(event)
        if event.phase == "will" then
            ...
            backgroundImage = display.newRect(0, 
                                            ...
                                            scrollView.width, 
                                            scrollView.height )
            backgroundImage.x = (display.contentWidth - 2*display.screenOriginX)*0.5
            backgroundImage.y = backgroundImage.height*0.5
        ...
        if event.phase == "did" then
            ...
            print("messageGroup.numChildren=",messageGroup.numChildren)
            ...
            if Process.getisDownloading() then
                ...
                print("==================isDownloading===",Process.getisDownloading())
